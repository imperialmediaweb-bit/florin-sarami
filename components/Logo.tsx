...
// h_220 livrează imaginea la rezoluție dublă față de afișare (claritate pe retina)
// (transformări făcute de Cloudinary direct din URL, imaginea originală rămâne neatinsă)
const CLOUDINARY_LOGO =
  'https://res.cloudinary.com/kaz6teok/image/upload/e_trim:10/e_make_transparent:20/h_220,c_fit,q_auto/v1786184469/Screenshot_1049_mdo29q.png';
